    ...
    ntw_client_t *cl)
{
    ...
    min_case[0] = MIN_CASE_SUB(trantorien->x, lvl, map->width);
    min_case[1] = MIN_CASE_SUB(trantorien->y, lvl, map->height);
    ...
    ntw_client_t *cl)
{
    ...
    min_case[0] = MIN_CASE_ADD(trantorien->x, lvl, map->width);
    min_case[1] = MIN_CASE_SUB(trantorien->y, lvl, map->height);
    ...
    ntw_client_t *cl)
{
    ...
    min_case[0] = MIN_CASE_ADD(trantorien->x, lvl, map->width);
    min_case[1] = MIN_CASE_ADD(trantorien->y, lvl, map->height);
    last_lvl_case = (trantorien->x - lvl) % map->width;
    last_lvl_case = (last_lvl_case < 0) ?
        last_lvl_case + map->width : last_lvl_case;
